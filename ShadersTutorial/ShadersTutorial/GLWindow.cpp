...
void GLWindow::sendDataToOpenGL()
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, normalMapImg.width(), normalMapImg.height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, normalMapImg.bits());
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
...
void GLWindow::paintGL()
{
	...
	glBindVertexArray(cubeVertexArrayObjectID);
	glm::mat4 cube1ModelToWorldMatrix = glm::translate(diffuseLightPosition) * glm::scale(0.05f, 0.05f, 0.05f);
